...
export class HomeworkListComponent implements OnInit {
  ...
  editHomework(homework: HomeworkDtoModel) {
    ...
    const dialogRef = this.dialog.open(HomeworkEditDialogComponent, { data: { homework, _saveMessage } });
    dialogRef.afterClosed().subscribe(res => {
      if (!res) {
        return;
      }
      ...
      this.loadHomeworksList(homework.classesId, homework.sectionId, homework.subjectGroupSubjectId, homework.subjectId);
    });
  }
