...
export class FeesDiscountComponent implements OnInit {
	...
	assignDiscountFeesToStudent(feesDiscount: FeesDiscountModel) {
		...
		// 	}
		// })
		// /fees_collection/fees_discount/assign/1
		this.router.navigate(['/fees_collection/fees_discount/assign/' + feesDiscount.id]);
		const _saveMessage = 'Assigned fees to the students';
