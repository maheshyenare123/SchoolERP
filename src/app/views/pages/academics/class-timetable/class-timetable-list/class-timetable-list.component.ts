...
export class ClassTimetableListComponent implements OnInit {
  ...
  getAllClassTimetableListByservice(classId, sectionId) {
    ...
    this.classTimetableService.getAllClassTimetables(classId, sectionId).subscribe(res => {
      ...
      if (this.classTimetablesData.timetable.monday.length > 0) {
        this.maxSizeCard = this.classTimetablesData.timetable.monday.length;
      }

      if (this.maxSizeCard < this.classTimetablesData.timetable.tuesday.length) {
        this.maxSizeCard = this.classTimetablesData.timetable.tuesday.length;
      }
      
      if (this.maxSizeCard < this.classTimetablesData.timetable.wednesday.length) {
        this.maxSizeCard = this.classTimetablesData.timetable.wednesday.length;
      }
      if (this.maxSizeCard < this.classTimetablesData.timetable.thursday.length) {
        this.maxSizeCard = this.classTimetablesData.timetable.thursday.length;
      }
      if (this.maxSizeCard < this.classTimetablesData.timetable.friday.length) {
        this.maxSizeCard = this.classTimetablesData.timetable.friday.length;
      }
      if (this.maxSizeCard < this.classTimetablesData.timetable.saturday.length) {
        this.maxSizeCard = this.classTimetablesData.timetable.saturday.length;
      }
      if (this.maxSizeCard < this.classTimetablesData.timetable.sunday.length) {
        this.maxSizeCard = this.classTimetablesData.timetable.sunday.length;
      }
      ...
      // let myMap = new Map();
      // myMap=this.classTimetablesData.timetable;
