...
export class SearchIncomeComponent implements OnInit {
  ...
  onSearch() {
    ...
    this.getAllIncomeList(fromDate,toDate);


  }

  getAllIncomeList(fromDate,toDate) {
    ...
    **/
    const paginatorSubscriptions = merge(this.sort.sortChange, this.paginator.page).pipe(
      tap(() => this.loadIncomeList(fromDate,toDate))
    )
      .subscribe();
    ...
    of(undefined).pipe(take(1), delay(1000)).subscribe(() => { // Remove this line, just loading imitation
      this.loadIncomeList(fromDate,toDate);
   ...
   */
  loadIncomeList(fromDate,toDate) {
    debugger;
    ...
    this.store.dispatch(new IncomesPageRequested({ page: queryParams, fromDate: fromDate, toDate: toDate }));
    this.selection.clear();
  }
