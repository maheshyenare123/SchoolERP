...
export class SubjectGroupService {
  ...
  // READ with class and section
  getAllSubjectGroupsWithClassAndSection(classId, sectionId): Observable<SubjectGroupDtoModel[]> {
    const httpHeaders = this.httpUtils.getHTTPHeaders();
    const httpParams = new HttpParams()
      .set('classesId', classId)
      .set('sectionId', sectionId);
    return this.http.get<SubjectGroupDtoModel[]>(Constants.URL.HOST_URL + Constants.Academics.Subject_Group, { headers: httpHeaders, params: httpParams });
  }
